...
class EditableImage extends StatefulWidget {
  ...
  const EditableImage({super.key, required this.initialImagePath});
...
class _EditableImageState extends State<EditableImage> {
  ...
  void initState() {
    super.initState();
    // Call _addImage with the initialImagePath when the widget is initialized
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final RenderBox renderBox = context.findRenderObject() as RenderBox;
      final Offset center = renderBox.size.center(Offset.zero);
      _addImage(widget.initialImagePath, center - const Offset(50, 50));
    });
  }
